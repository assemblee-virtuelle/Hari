...
/**
 * \ActivityPub\Type\TypeResolver is an abstract class for
...
abstract class TypeResolver
{
    ...
    protected static $coreTypes = [
        'Activity', 'Collection', 'CollectionPage', 'Hashtag', 
    ...
    protected static $actorTypes = [
        'Application', 'Group', 'Organization', 'Person', 'MastodonPerson',
        'PeerTubePerson', 'Service'
    ];
    ...
    protected static $objectTypes = [
        'Article', 'Audio', 'Document', 'Emoji', 'Event', 'Image',
        'Mention', 'Note', 'MastodonNote', 'Page', 'Place', 'Profile',
        'Relationship', 'Tombstone', 'Video', 'PeerTubeVideo'
    ];
