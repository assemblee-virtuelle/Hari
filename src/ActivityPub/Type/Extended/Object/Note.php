...
class Note extends ObjectType
{
    ...
    protected $sensitive;               // Mastodon specific

    protected $atomUri;                 // Mastodon specific

    protected $inReplyToAtomUri;        // Mastodon specific

    protected $conversation;            // Mastodon specific
}
