...
class Actor
{
    ...
    {
        //var_dump($this->url);
        //var_dump((new Request())->get($this->url));
        //var_dump(json_decode((new Request())->get($this->url)));
        $content = json_decode(
        ...
        } elseif (array_key_exists('pt', $content['@context'][2])) {

          $this->actor = Type::create('PeerTube'.$content['type'], $content);
